...
git clone https://github.com/ali-iraqi/ali_iraqi.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf ali_iraqi && rm -rf .telegram-cli && git clone https://github.com/ali-iraqi/ali_iraqi.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
